...
bool ackMessage::getPerformed() const
{
    return this->performed;
}

void ackMessage::setPerformed(bool performed)
{
    this->performed = performed;
}

int ackMessage::getNodeNumber() const
{
    return this->nodeNumber;
}

void ackMessage::setNodeNumber(int nodeNumber)
{
    this->nodeNumber = nodeNumber;
}

const char * ackMessage::getPartition() const
{
    return this->partition.c_str();
}

void ackMessage::setPartition(const char * partition)
{
